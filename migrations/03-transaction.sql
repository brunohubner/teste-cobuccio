...
CREATE TABLE IF NOT EXISTS public.transaction (
	...
	status character varying(20) CHECK (status IN ('pending', 'completed', 'cancelled', 'rejected')) NOT NULL DEFAULT 'pending',
	previousHash character varying(64) COLLATE pg_catalog."default" NOT NULL,
